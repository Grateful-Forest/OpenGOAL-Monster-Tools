...
- Take no action other than choose what you want, drag lines for paths, size spheres for obstacles, or paint areas for jumps.
...
3. Go to 3D View > Right Sidebar and Export.
